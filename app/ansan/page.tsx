...
export const metadata: Metadata = {
  title: "안산 출장마사지 | 출장안마 | 노마드 - 24시간 홈케어",
  description:
    "안산 출장마사지, 출장안마 전문 노마드출장마사지입니다. 안산시 단원구, 상록구 전 지역 24시간 방문 케어, 100% 후불제. 일상의 피로를 풀어주는 프리미엄 힐링을 경험하세요.",
  keywords:
    "안산출장마사지, 안산출장안마, 안산마사지, 단원구출장안마, 상록구출장마사지, 중앙동출장, 고잔동출장",
  openGraph: {
    title: "안산 출장마사지 & 출장안마 | 노마드출장마사지",
    description: "경기도 안산시 1등 출장마사지. 24시간 언제든 편안하게 예약하고 최상의 홈케어 서비스를 경험하세요.",
    url: "https://nomadthai.kr/ansan",
  },
  alternates: {
    canonical: "https://nomadthai.kr/ansan",
  },
};
