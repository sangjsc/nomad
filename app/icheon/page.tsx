...
export const metadata: Metadata = {
  title: "이천출장마사지 | 이천출장안마·홈타이 예약 안내 | 오후 7시~오전 4시",
  description:
    "경기도 이천시 전 지역 이천출장마사지·이천출장안마·이천 홈타이 예약 안내. 오후 7시~오전 4시 운영, 100% 후불제, 전화·카카오톡 상담이 가능합니다.",
  openGraph: {
    title: "이천출장마사지 | 이천출장안마·홈타이 예약 안내 | 노마드출장마사지",
    description: "경기도 이천시 전 지역 이천출장마사지·이천출장안마 예약 안내. 오후 7시~오전 4시 운영, 100% 후불제로 안심하고 이용하세요.",
  ...
  twitter: {
    ...
    title: "이천출장마사지 | 이천출장안마 노마드출장마사지",
    description: "이천시 전 지역 오후 7시~오전 4시 이천출장마사지·이천 홈타이 예약. 100% 후불제로 이용 가능합니다.",
    images: ["/og/icheon"],
  },
  alternates: {
  ...
  return (
    <LocationPage
      ...
      serviceDescription={
        <>
          <p>
            노마드출장마사지 이천 서비스는 타이, 아로마, 스웨디시 등 코스와 이용 시간을 상담하고 현재 위치에 맞는 방문 가능 일정을 안내합니다. 예약할 때 원하는 관리 방식과 강도, 이용 장소를 함께 알려주시면 선택 가능한 코스를 비교하기 쉽습니다. 모든 서비스는 예약금과 선입금 없이 관리사 도착 확인 후 결제하는 후불제로 운영합니다.
          </p>
        </>
      }
      localGuide={
