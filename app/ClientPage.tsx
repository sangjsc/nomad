            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/" className="flex items-center space-x-3 lg:space-x-4">
                ...
                <div>
                  ...
                  <div className="text-xs lg:text-sm text-rose-500 font-medium">경기도 전문 출장마사지</div>
                </div>
              </Link>
              ...
              <nav className="hidden xl:flex items-center space-x-6 text-sm font-medium text-gray-600">
                <Link
                  href="/"
                  className="hover:text-rose-500 transition-all duration-300 relative group text-rose-500 font-bold"
                >
                  홈<span className="absolute -bottom-1 left-0 w-full h-0.5 bg-rose-500"></span>
                </Link>
                <Link href="/icheon" className="hover:text-rose-500 transition-all duration-300 relative group">
                  이천 출장마사지
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rose-500 transition-all duration-300 group-hover:w-full"></span>
                </Link>
                <Link href="/gwangju" className="hover:text-rose-500 transition-all duration-300 relative group">
                  광주 출장마사지
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rose-500 transition-all duration-300 group-hover:w-full"></span>
                </Link>
                <Link href="/yeoju" className="hover:text-rose-500 transition-all duration-300 relative group">
                  여주 출장마사지
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rose-500 transition-all duration-300 group-hover:w-full"></span>
                </Link>
                <Link href="/yongin" className="hover:text-rose-500 transition-all duration-300 relative group">
                  용인 출장마사지
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rose-500 transition-all duration-300 group-hover:w-full"></span>
                </Link>
                <Link href="#services" className="hover:text-rose-500 transition-all duration-300 relative group">
                  서비스 & 가격
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rose-500 transition-all duration-300 group-hover:w-full"></span>
                </Link>
              </nav>
                ...
                <div className="xl:hidden">
                  <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
                    ...
                    <SheetContent side="right" className="w-[300px] sm:w-[400px] bg-white/95 backdrop-blur-xl">
                      <SheetHeader>
                        <SheetTitle className="text-2xl font-bold text-gray-800">메뉴</SheetTitle>
                      </SheetHeader>
                      <div className="mt-8 flex flex-col space-y-4">
                        <SheetClose asChild>
                          <Link href="/" className="text-lg font-medium text-gray-700 hover:text-rose-500 transition-colors">홈</Link>
                        </SheetClose>
                        <SheetClose asChild>
                          <Link href="/icheon" className="text-lg font-medium text-gray-700 hover:text-rose-500 transition-colors">이천 출장마사지</Link>
                        </SheetClose>
                        <SheetClose asChild>
                          <Link href="/gwangju" className="text-lg font-medium text-gray-700 hover:text-rose-500 transition-colors">광주 출장마사지</Link>
                        </SheetClose>
                        <SheetClose asChild>
                          <Link href="/yeoju" className="text-lg font-medium text-gray-700 hover:text-rose-500 transition-colors">여주 출장마사지</Link>
                        </SheetClose>
                        <SheetClose asChild>
                          <Link href="/yongin" className="text-lg font-medium text-gray-700 hover:text-rose-500 transition-colors">용인 출장마사지</Link>
                        </SheetClose>
                        <SheetClose asChild>
                          <Link href="#services" className="text-lg font-medium text-gray-700 hover:text-rose-500 transition-colors">서비스 & 가격</Link>
                        </SheetClose>
                      </div>
                    </SheetContent>
                  </Sheet>
